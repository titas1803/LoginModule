...
public class UserRestController {
	...
	public SuccessMessage createUserRegistration(@Valid @RequestBody UserDto userdto, BindingResult br) throws ValidateUserException {
		if(br.hasErrors())
	...
	public List<User> viewUsers(@RequestHeader("token-id") String tokenId) throws LoginException, UserNotFoundException{
